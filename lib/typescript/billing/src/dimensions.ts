...
export const DIMENSION_DISPLAY: Record<string, DimensionDisplay> = {
  ...
  object_storage_write_request: {
    label: "Storage writes and lists",
    unit: "requests",
    divisor: 1n,
  },
  object_storage_read_request: { label: "Storage reads", unit: "requests", divisor: 1n },
  object_storage_egress_byte: { label: "Storage egress", unit: "GB", divisor: 1_000_000_000n },
  object_storage_gb_month: { label: "Object storage", unit: "GB-months", divisor: 1n },
