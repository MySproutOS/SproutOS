...
export const DEPLOYMENT_DOCTRINE = [
  ...
  "arrives as, how the customer's workflow gates deploys on migrations, and what has no home here at all.",
  "",
  ...
  "6. Customer-owned database migrations on push — prefer a dedicated migrator project and make every affected application deploy wait for its GitHub Actions job. SproutOS does not discover migrations automatically.",
  "",
