...
export const GENERATED_DOC_CONTENT: Record<string, RenderableTreeNode[]> = {
  ...
  cli: [
    ...
    },
    {
      ...
      attributes: {},
      children: [
        "On macOS or Linux, install the latest production-approved release without ",
        {
          $$mdtype: "Tag",
          name: "code",
          attributes: {},
    ...
    },
    {
      ...
      children: ["curl --proto '=https' --tlsv1.2 -fsSL https://sproutos.me/install.sh | bash\n"],
    },
    {
      $$mdtype: "Tag",
      name: "p",
      ...
      children: [
        ...
        " ",
        "release selected by SproutOS production, verifies its SHA-256 digest, and installs ",
        {
          $$mdtype: "Tag",
          name: "code",
          attributes: {},
    ...
    },
    {
      ...
      children: [
        ...
        "downloads on the ",
        {
          ...
          name: "DocLink",
          attributes: {
            href: "/download#sprout-cli",
          },
          children: ["SproutOS download page"],
        },
        ". Each promoted release includes",
        " ",
        {
          $$mdtype: "Tag",
          name: "code",
        ...
        " and a versioned manifest alongside its five platform archives.",
      ],
    },
    {
      $$mdtype: "Tag",
      name: "p",
      attributes: {},
      children: ["Then check the installed version:"],
    },
    {
      $$mdtype: "Tag",
      name: "CodeBlock",
  ...
  "github-action": [
    ...
    },
    {
      ...
      attributes: {},
      children: [
        "Install the latest production-approved ",
        {
          $$mdtype: "Tag",
          name: "code",
          attributes: {},
        ...
        " release on macOS or Linux, then sign in and deploy:",
      ],
    },
    {
      $$mdtype: "Tag",
    ...
    },
    {
      ...
      children: [
        ...
        " links directly to the promoted release's macOS arm64 and",
        " ",
