...
v0.1.0, so CI and a local terminal package and publish the same artifact.
...
[SproutOS CLI v0.1.0 release](https://github.com/MySproutOS/SproutOS/releases/tag/cli-v0.1.0), then
sign in and deploy:
...
plus `SHA256SUMS` and `sprout-v0.1.0-manifest.json`. Verify the selected archive against both files.
