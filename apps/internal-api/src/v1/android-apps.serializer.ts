...
export const androidAppSchemaResponse = Type.Object({
  ...
  registrationProviderState: Nullable(
    Type.Union([
  ...
  registrationCheckAttempts: Type.Integer({ minimum: 0 }),
  registrationLastCheckedAt: Nullable(Type.String({ format: "date-time" })),
  registrationNextCheckAt: Type.String({ format: "date-time" }),
  registrationLastFailure: Nullable(Type.String()),
