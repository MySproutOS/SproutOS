...
| `store_listing`                 | store          | catalogue entry; `canonical_android_app_id` is its one explicit public APK release ([0015](../adr/0015-store-table-is-store-listing.md)) | `store_category`, `user` ×2, `android_app`                                   |
...
| `price_book_item`               | billing        | unit price plus nullable per-dimension `overhead_bps` override                                                                           | `price_book`                                                                 |
...
| `provider_usage_reconciliation` | billing        | Daily comparable provider/imported request counts; residual is platform overhead                                                         | —                                                                            |
